    ...
    >
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] mb-6 tracking-tight relative font-sans">
            How I research, build, and ship
            {/* Hand-drawn arrow */}
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            Every project I touch goes from curiosity to published research, shipped code, or a live product. Here's how I think.
          </p>
        </div>
        ...
        {/* Cards Container */}
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0 font-sans">
          
          <TagCard 
            number="01"
            title="Understand the Threat"
            text="I start by going deep on the problem space — whether that's reverse engineering a kernel driver in Ghidra, studying attack patterns across 15+ BYOVD exploits, or mapping malware behaviour layer by layer. Research before code, always."
          ...
          <TagCard 
            ...
            text="I architect around the problem — FastAPI backends, MongoDB pipelines, multi-agent LLM orchestration, or quantum-classical ML models. I build things that are real, not demo-ware."
          ...
          <TagCard 
            ...
            text="Most of my best work was built on deadlines — national hackathons, research internship timelines, IEEE submission windows. I'm comfortable going from zero to deployed fast."
          ...
          <TagCard 
            ...
            text="I don't just build and move on. I write IEEE papers, maintain GitHub repos, build databases like DriverArmory, and publish datasets to IEEE DataPort. The work lives beyond the project."
          ...
          >
            Research that ships. Work that lasts.
          </div>
